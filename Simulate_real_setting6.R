...
for (nrho in 1:length(rho2_grid)){
  for (nn in 1:nSim){
    ...
    betaC_ini = rep(1, p) #inital values of betaC
    betaD_ini = rnorm(p,0,1) #inital values of betaD
    Sc = sqrt(rho2/p) #scale prameter for betaC_ini
